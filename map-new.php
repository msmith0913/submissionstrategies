...
// People
		var RichardII = L.marker([51.499673068298016, -0.12474482944096953], {
			...
			fillOpacity: 0.5,
			radius: 30
		}).bindPopup('<strong>Name: Richard II</strong><br/><Role: Authority<br/>Positions: King of England and France; Lord of Ireland<br/>Location: Westminster Palace<br/><a href="/places/richard-ii.php">View resources</a>');
		var JohnStanley = L.marker([53.57605516263993, -2.8180305756709085], {
			color: 'red',
			fillColor: '#f03',
			fillOpacity: 0.5,
			radius: 30
		}).bindPopup('<strong>Name: John Stanley</strong><br/><Role: Authority<br/>Positions: member of court, formerly Lord Lieutenant and Justiciar of Ireland<br/>Location: Lathom House, Lancashire<br/><a href="/people/Stanley.php">View resources</a>');
...
//		var instrument22 = L.layerGroup([RichardBpOssory,ArtOgMacMurrough, FergalOCurran, RobertShortal, JohnSaykyn]);

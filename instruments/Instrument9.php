...
<head>
  ...
  <title>Instrument 9: The Submission of Maurice Magennis</title>
...
<body>
  ...
  <main>
    <h1>Notarial Instrument 9</h1>
    <h2>The Submission of Maurice Magennis</h2>
    <h3>Submission text (English, translated by Edmund Curtis)</h3>
    <p>Notarial Instrument IX records that: on the 16th day of March, 1395, and in the same place in Drogheda, in presence of the King and the notary, Maurice [Muirchertach] Magennis, removing his girdle, &c., and on bended knees, &c., took these words in Irish, which were rendered into English by Stephen Garnon, interpreter, in the presence of many understanding Irish, viz.:</p>
<p>‘I, Maurice Magennis, become liegeman of my Lord Richard’, &c. [as in Instrument I].</p>
...
<p>Witnesses as in Instrument VIII, omitting the Archbishop of Armagh.</p>
<button onclick="witnessexpand()">+</button>
<div id="witness" style="display: none; border-style: solid;">
  <h4><i>Witnesses from <a href="../instruments/Instrument8.php">Instrument 8</a></i></h4>
<p>Witnesses: Thomas, Archbishop of York, John of Armagh, Primate of all Ireland, the bishops of London, Chichester, and Llandaff, Thomas Mowbray, Earl of Nottingham, Thomas Percy, Marshal of the Household, and William Scrope, the King’s
  Chamberlain.</p>
</div>
<script>

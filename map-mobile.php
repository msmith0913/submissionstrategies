...
<body>
	...
	<p>By default, all people and place layers are turned on, and submission layers are turned off. Hover over either of the two layer buttons in the top right corner to toggle the layers, either individually or in groups. When the data appears on the
		map, you can click on each point or line to see more information.</p>
	...
	<p>The Submissions layers show each submission event, as recorded in notarial instruments. Each Submission layer includes the individuals named, the site of the submission, and color-coded links indicating the role of each person in the submission:
		authorities in purple, submitting parties in orange, interpreters in green, and witnesses in gold.</p>
	<p>For mobile users, please <a href="/map-mobile.php"><strong>click here</strong></a>.</p>
	...
	<script>
		...
		L.tileLayer('https://api.maptiler.com/maps/topo/{z}/{x}/{y}.png?key=4CI3hvSGGwgJXODif6KH', {
		...
		// Places
		// Secular sites
		var Westminster = L.marker([51.499673068298016, -0.12474482944096953], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Westminster Palace</strong><br/><a href="/places/Westminster.php">View resources</a>');
		var Dungannon = L.marker([54.5063072522902, -6.768650213215768], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Dungannon</strong><br/><a href="/places/Dungannon.php">View resources</a>');
		var DublinCastle = L.marker([53.343059024832215, -6.267460588689023], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Dublin Castle</strong><br/><a href="/places/DublinCastle.php">View resources</a>');
		var Tandragee = L.marker([54.35433661014168, -6.417615938831388], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Tandragee</strong><br/><a href="/places/Tandragee.php">View resources</a>');
		var Ballykean = L.marker([53.222980096917325, -7.262605604662662], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Ballykean</strong><br/><a href="/places/Ballykean.php">View resources</a>');
		var Ferns = L.marker([52.590900115704486, -6.500068251353481], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Ferns</strong><br/><a href="/places/FernsCastle.php">View resources</a>');
		var Ballintober = L.marker([53.722734056115634, -8.415850491520471], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Ballintober</strong><br/><a href="/places/Ballintober.php">View resources</a>');
		var Ballycarbery = L.marker([51.94903099242467, -10.258605292800087], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Ballycarbery</strong><br/><a href="/places/Ballycarbery.php">View resources</a>');
		var Dundrum = L.marker([54.26405024505779, -5.844814792025816], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Dundrum</strong><br/><a href="/places/DundrumDown.php">View resources</a>');
		var Glin = L.marker([52.57014569642131, -9.294740763174241], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Glin</strong><br/><a href="/places/GlinCastle.php">View resources</a>');
		var Belleek = L.marker([54.120883056109335, -9.142255900242674], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Belleek Castle</strong><br/><a href="/places/Belleek.php">View resources</a>');
		var ClonroadMore = L.marker([52.84795897344801, -8.972026293564303], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Clonroad More</strong><br/><a href="/places/ClonroadMore.php">View resources</a>');
		var Dunamase = L.marker([53.032003403834636, -7.210730631050135], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Dunamase</strong><br/><a href="/places/Dunamase.php">View resources</a>');
		var Rathangan = L.marker([53.21965782033275, -7.0021621740278945], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Rathangan</strong><br/><a href="/places/Rathangan.php">View resources</a>');
		var Castlecomer = L.marker([52.80625387806498, -7.202831361169027], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Castlecomer</strong><br/><a href="/places/Castlecomer.php">View resources</a>');
		var Aghaboe = L.marker([52.92378377374355, -7.513021134328597], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Aghaboe</strong><br/><a href="/places/Aghaboe.php">View resources</a>');
		var Powerscourt = L.marker([53.18463122519382, -6.1872523309723855], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Powerscourt</strong><br/><a href="/places/Powerscourt.php">View resources</a>');
		var KilkennyCastle = L.marker([52.65042963544829, -7.249515224539098], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Kilkenny Castle</strong><br/><a href="/places/KilkennyCastle.php">View resources</a>');
		var Nenagh = L.marker([52.865144995499804, -8.19816891618452], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Nenagh</strong><br/><a href="/places/NenaghCastle.php">View resources</a>');
		var Castleconnell = L.marker([52.71213203579604, -8.503683679502876], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Castleconnell</strong><br/><a href="/places/CastleConnell.php">View resources</a>');
		var Gaulstown = L.marker([52.30933453171065, -7.113833917056847], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Gaulstown</strong><br/><a href="/places/Gaulstown.php">View resources</a>');
		var BlackCastle = L.marker([53.09741653963109, -7.9157475753839455], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Black Castle</strong><br/><a href="/places/BlackCastle.php">View resources</a>');
		var Athenry = L.marker([53.29989540496307, -8.74539918683801], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Athenry</strong><br/><a href="/places/Athenry.php">View resources</a>');
		var Lixnaw = L.marker([52.402309862021305, -9.628663487621754], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Lixnaw</strong><br/><a href="/places/Lixnaw.php">View resources</a>');
		var Kilbrittain = L.marker([51.67552178247685, -8.679032758580476], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Kilbrittain</strong><br/><a href="/places/Kilbrittain.php">View resources</a>');
		var KingJohns = L.marker([52.669900149141625, -8.625543760062053], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Limerick (King John&apos; Castle)</strong><br/><a href="/places/Limerick.php">View resources</a>');
		var Macroom = L.marker([51.90520051539335, -8.96220776599217], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Macroom</strong><br/><a href="/places/MacroomCastle.php">View resources</a>');
		var Reginalds = L.marker([52.26060981564144, -7.105420502725048], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Waterford (Reginald&apos;sTower)</strong><br/><a href="/places/Waterford.php">View resources</a>');
		var Geoghegan = L.marker([53.443415225674656, -7.489401350912528], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Castletown Geoghegan</strong><br/><a href="/places/CastletownGeoghegan.php">View resources</a>');
		var Tullymongan = L.marker([53.9887817355458, -7.357948192232346], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Tullymongan Hill</strong><br/><a href="/places/TullymonganHill.php">View resources</a>');
		var Lissardowlan = L.marker([53.71558456704111, -7.7181397682899116], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Lissardowlan</strong><br/><a href="/places/Lissardowlan.php">View resources</a>');
		var Ballygory = L.marker([52.835027006518125, -6.7951297352061655], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Balygory</strong><br/><a href="/places/Balygory.php">View resources</a>');
		var CarlowCastle = L.marker([52.83634711708233, -6.935924273548353], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Carlow Castle</strong><br/><a href="/places/Carlow.php">View resources</a>');
		var OBrenansCross = L.marker([52.75435526930308, -7.233432388026526], {
			icon: castleIcon
		}).bindPopup('<strong>Location: O&apos;Brenan&apos;s Cross</strong><br/><a href="/places/OBrenansCross.php">View resources</a>');
		var TrinityShip = L.marker([52.259967122054654, -7.035138093268444], {
			icon: castleIcon
		}).bindPopup('<strong>Location: The ship <i>Trinity</i> in the port of Waterford</strong><br/><a href="/places/Trinity.php">View resources</a>');
		var CarlowCastleMeadow = L.marker([52.83629323692305, -6.936742953013918], {
			icon: castleIcon
		}).bindPopup('<strong>Location: a meadow near Carlow Castle</strong><br/><a href="/places/Carlow.php">View resources</a>');
		var RochesterCastle = L.marker([51.38989748942007, 0.5014839976535792], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Rochester Castle</strong><br/><a href="/places/RochesterCastle.php">View resources</a>');
		var EpworthCastle = L.marker([53.52635679996112, -0.8166546393819635], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Epworth Castle</strong><br/><a href="/places/Epworth.php">View resources</a>');
		var Clonakenny = L.marker([52.87305674403316, -7.830682165940664], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Clonakenny</strong><br/><a href="/places/Clonakenny.php">View resources</a>');
		var NewLeighlin = L.marker([52.73585151137786, -6.977905724552096], {
			icon: castleIcon
		}).bindPopup('<strong>Location: New Leighlin</strong><br/><a href="/places/NewLeighlin.php">View resources</a>');
		var Ardee = L.marker([53.85559383682583, -6.538777287683988], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Ardee, Co. Louth</strong><br/><a href="/places/Ardee.php">View resources</a>');
		var Adlington = L.marker([53.462108966185845, -1.8347426301840812], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Adlington Hall, Adlington, Cheshire</strong><br/><a href="/places/Adlington.php">View resources</a>');
		var Amington = L.marker([52.64613756609573, -1.6602881697634575], {
			icon: castleIcon
		}).bindPopup('<strong>Location: Amington, Warwickshire</strong><br/><a href="/places/Amington.php">View resources</a>');
		var Ballylarkin = L.marker([52.722927527824325, -7.429464308400038], {
			icon: castleIcon
		}).bindPopup('<strong>Ballylarkin, Co. Kilkenny</strong><br/><a href="/places/Ballylarkin.php">View resources</a>');
		var Ballymote = L.marker([54.08791447559624, -8.519896161365837], {
			icon: castleIcon
		}).bindPopup('<strong>Ballymote Castle, Co. Sligo</strong><br/><a href="/places/Ballymote.php">View resources</a>');
		var Berkhamsted = L.marker([51.76391915878651, -0.5598456374405312], {
			icon: castleIcon
		}).bindPopup('<strong>Berkhamsted Castle, Hertfordshire</strong><br/><a href="/places/Berkhamsted.php">View resources</a>');
		var Bunratty = L.marker([52.696672602478685, -8.812124229456206], {
			icon: castleIcon
		}).bindPopup('<strong>Bunratty Castle, Co. Clare</strong><br/><a href="/places/Bunratty.php">View resources</a>');
		var Castlebrack = L.marker([53.19734368382633, -7.395264768246803], {
			icon: castleIcon
		}).bindPopup('<strong>Castlebrack, Co. Laois</strong><br/><a href="/places/Castlebrack.php">View resources</a>');
		var Castleconor = L.marker([54.16135919981353, -9.13570253897111], {
			icon: castleIcon
		}).bindPopup('<strong>Castleconor, Co. Mayo</strong><br/><a href="/places/Castleconor.php">View resources</a>');
		var Chailesmore = L.marker([52.394108639873494, -1.5074072768538256], {
			icon: castleIcon
		}).bindPopup('<strong>Chailesmore, Warwickshire</strong><br/><a href="/places/Chailesmore.php">View resources</a>');
		var CherryIsland = L.marker([54.04985991824453, -7.700510175480083], {
			icon: castleIcon
		}).bindPopup('<strong>Cherry Island, Co. Leitrim</strong><br/><a href="/places/CherryIsland.php">View resources</a>');
		var Cleeton = L.marker([52.414060668199724, -2.551913023839098], {
			icon: castleIcon
		}).bindPopup('<strong>Cleeton St Mary and Farlow, Shropshire</strong><br/><a href="/places/Cleeton.php">View resources</a>');
		var Clonderalaw = L.marker([52.64641698823626, -9.271418338721034], {
			icon: castleIcon
		}).bindPopup('<strong>Clonderalaw, Co. Clare</strong><br/><a href="/places/Clonderalaw.php">View resources</a>');
		var Coity = L.marker([51.522118189614524, -3.5532030889493202], {
			icon: castleIcon
		}).bindPopup('<strong>Coity Castle, Glamorgan, Wales</strong><br/><a href="/places/CoityCastle.php">View resources</a>');
		var DundrumTipp = L.marker([52.5547648658257, -8.029001639898715], {
			icon: castleIcon
		}).bindPopup('<strong>Dundrum Castle, Co. Tipperary</strong><br/><a href="/places/Dundrum.php">View resources</a>');
		var Dysert = L.marker([52.91148123006832, -9.066378702380634], {
			icon: castleIcon
		}).bindPopup('<strong>Dysert O&apos;Dea, Co. Clare</strong><br/><a href="/places/DysertODea.php">View resources</a>');
		var Felbrigg = L.marker([52.907339265628885, 1.2593998313554615], {
			icon: castleIcon
		}).bindPopup('<strong>Felbrigg Hall, Norfolk</strong><br/><a href="/places/FelbriggHall.php">View resources</a>');
		var Fotheringay = L.marker([52.524520973168976, -0.4355533758965811], {
			icon: castleIcon
		}).bindPopup('<strong>Fotheringay Castle, Northamptonshire</strong><br/><a href="/places/FotheringayCastle.php">View resources</a>');
		var Guernsey = L.marker([49.45331609939186, -2.526401592247284], {
			icon: castleIcon
		}).bindPopup('<strong>Guernsey (Castle Cornet)</strong><br/><a href="/places/Guernsey.php">View resources</a>');
		var Ilketshall = L.marker([52.43010934544872, 1.4954321165131703], {
			icon: castleIcon
		}).bindPopup('<strong>Ilketshall, Suffolk</strong><br/><a href="/places/Suffolk.php">View resources</a>');
		var Kempston = L.marker([52.12027053565773, -0.49714784138783447], {
			icon: castleIcon
		}).bindPopup('<strong>Kempston Brucebury, Bedfordshire</strong><br/><a href="/places/Kempston.php">View resources</a>');
		var Kingsbury = L.marker([52.56440782939598, -1.6855107351464125], {
			icon: castleIcon
		}).bindPopup('<strong>Kingsbury Hall, Warwickshire</strong><br/><a href="/places/KingsburyHall.php">View resources</a>');
		var Lathom = L.marker([53.57605516263993, -2.8180305756709085], {
			icon: castleIcon
		}).bindPopup('<strong>Lathom House, Lancashire</strong><br/><a href="/places/Lathom.php">View resources</a>');
		var Leeds = L.marker([51.24904081361839, 0.6298944235039807], {
			icon: castleIcon
		}).bindPopup('<strong>Leeds Castle</strong><br/><a href="/places/LeedsCastle.php">View resources</a>');
		var Longford = L.marker([52.94211635775369, -1.68151073111044], {
			icon: castleIcon
		}).bindPopup('<strong>Longford Hall, Derbyshire</strong><br/><a href="/places/LongfordHall.php">View resources</a>');
		var Malahide = L.marker([53.44494090251295, -6.164572199713146], {
			icon: castleIcon
		}).bindPopup('<strong>Malahide Castle, Co. Dublin</strong><br/><a href="/places/MalahideCastle.php">View resources</a>');
		var Maxstoke = L.marker([52.499434452258235, -1.6717643002108515], {
			icon: castleIcon
		}).bindPopup('<strong>Maxstoke Castle, Warwickshire</strong><br/><a href="/places/MaxstokeCastle.php">View resources</a>');
		var MountTemple = L.marker([53.42937897421557, -7.775565548067066], {
			icon: castleIcon
		}).bindPopup('<strong>Mount Temple, Co. Westmeath</strong><br/><a href="/places/MountTemple.php">View resources</a>');
		var Newcastle = L.marker([53.07344505519419, -6.072130490017539], {
			icon: castleIcon
		}).bindPopup('<strong>Newcastle Middle, Co. Wicklow</strong><br/><a href="/places/NewcastleMiddle.php">View resources</a>');
		var Newgate = L.marker([51.51583646769191, -0.1016736882634505], {
			icon: castleIcon
		}).bindPopup('<strong>Newgate Gaol, London</strong><br/><a href="/places/Newgate.php">View resources</a>');
		var Nuneham = L.marker([51.683181629926416, -1.2127198637672658], {
			icon: castleIcon
		}).bindPopup('<strong>Nuneham, Oxfordshire</strong><br/><a href="/places/Nuneham.php">View resources</a>');
		var PortanTulchain = L.marker([53.11405971470972, -8.16440534487539], {
			icon: castleIcon
		}).bindPopup('<strong>Port an Tulchain, Co. Tipperary</strong><br/><a href="/places/PortanTulchain.php">View resources</a>');
		var RathTulach = L.marker([54.2403074168005, -6.975918985620835], {
			icon: castleIcon
		}).bindPopup('<strong>Rath Tulach, Co. Monaghan</strong><br/><a href="/places/RathTulach.php">View resources</a>');
		var Ricetown = L.marker([53.781099569143734, -6.676733656357843], {
			icon: castleIcon
		}).bindPopup('<strong>Ricetown, Co. Meath</strong><br/><a href="/places/Ricetown.php">View resources</a>');
		var LoughKey = L.marker([53.98956185474765, -8.232547955745472], {
			icon: castleIcon
		}).bindPopup('<strong>Rock of Lough Key, Co. Roscommon</strong><br/><a href="/places/LoughKey.php">View resources</a>');
		var Sarsden = L.marker([51.904770291595355, -1.5807271785418906], {
			icon: castleIcon
		}).bindPopup('<strong>Sarsden House, Oxfordshire</strong><br/><a href="/places/SarsdenHouse.php">View resources</a>');
		var Swithin = L.marker([51.51196153384987, -0.08960020234082573], {
			icon: castleIcon
		}).bindPopup('<strong>St. Swithin, London Stone</strong><br/><a href="/places/StSwithin.php">View resources</a>');
		var Trim = L.marker([53.55433368968523, -6.789908525336877], {
			icon: castleIcon
		}).bindPopup('<strong>Trim Castle, Co. Meath</strong><br/><a href="/places/TrimCastle.php">View resources</a>');
		var Wressle = L.marker([53.77546319856784, -0.9289391911809356], {
			icon: castleIcon
		}).bindPopup('<strong>Wressle Castle, Yorkshire</strong><br/><a href="/places/WressleCastle.php">View resources</a>');
		var Killamery = L.marker([52.476269, -7.444880], {
			icon: castleIcon
		}).bindPopup('<strong>Killamery, Co. Kilkenny</strong><br/><a href="/places/Killamery.php">View resources</a>');
		// Ecclesiastical sites
		var YorkMinster = L.marker([53.96261321710904, -1.082564232319088], {
			icon: churchIcon
		}).bindPopup('<strong>Location: York Minster</strong><br/><a href="/places/YorkMinster.php">View resources</a>');
		var OldStPauls = L.marker([51.51391872458704, -0.09835060227396925], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Old St. Paul&apos;s, London</strong><br/><a href="/places/OldStPaulCath.php>View resources</a>');
		var ChichesterCath = L.marker([50.836444616933846, -0.7806593023080537], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Chichester Cathedral</strong><br/><a href="/places/ChichesterCath.php">View resources</a>');
		var WellsCath = L.marker([51.210575282198946, -2.6434303599616404], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Wells Cathedral</strong><br/><a href="/places/WellsCath.php">View resources</a>');
		var ChristChurchDub = L.marker([53.34345533225444, -6.27106020218046], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Christchurch, Dublin</strong><br/><a href="/places/ChristChurchCath.php">View resources</a>');
		var ChristChurchWat = L.marker([52.26005051914892, -7.107510486891409], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Christ Church, Waterford</strong><br/><a href="/places/ChristChurchCathWat.php">View resources</a>');
		var RockCashel = L.marker([52.52018726099023, -7.890430744550451], {
			icon: churchIcon
		}).bindPopup('<strong>Location: The Rock of Cashel</strong><br/><a href="/places/Cashel.php">View resources</a>');
		var LlandaffCath = L.marker([51.49581515376926, -3.217197702793551], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Llandaff Cathedral</strong><br/><a href="/places/LlandaffCath.php">View resources</a>');
		var CathPeterPaul = L.marker([53.555824660725385, -6.7724734444970744], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Augustinian Priory of Ss. Peter and Paul, Co. Meath</strong><br/><a href="/places/PrioryPeterPaul.php">View resources</a>');
		var StCaniceCath = L.marker([52.65505417318262, -7.259360585833883], {
			icon: churchIcon
		}).bindPopup('<strong>Location: St. Canice&apos;s Cathedral, Kilkenny</strong><br/><a href="/places/StCaniceCath.php">View resources</a>');
		var StMaryCath = L.marker([53.84522952503657, -8.19067033028418], {
			icon: churchIcon
		}).bindPopup('<strong>Location: St. Mary&apos;s Cathedral, Elphin, Co. Roscommon</strong><br/><a href="/places/StMaryCath.php">View resources</a>');
		var StLaserianCath = L.marker([52.73610773387068, -7.025380359884095], {
			icon: churchIcon
		}).bindPopup('<strong>Location: St. Laserian&apos;s Cathedral, Oldleighlin, Co. Carlow</strong><br/><a href="/places/StLaserianCath.php">View resources</a>');
		var StMullins = L.marker([52.984871314450615, -6.808651542688595], {
			icon: churchIcon
		}).bindPopup('<strong>Location: St. Mullins Church, Timolin, Co. Kildare</strong><br/><a href="/places/StMullinsChurch.php">View resources</a>');
		var CoventryCath = L.marker([52.408720821933144, -1.507126275731839], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Coventry Cathedral</strong><br/><a href="/places/CoventryCath.php">View resources</a>');
		var LichfieldCath = L.marker([52.68563576496434, -1.8303309315376164], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Lichfield Cathedral</strong><br/><a href="/places/LichfieldCath.php">View resources</a>');
		var ElyCath = L.marker([52.3989490180776, 0.2624057062999244], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Ely Cathedral</strong><br/><a href="/places/ElyCath.php">View resources</a>');
		var Donaghmore = L.marker([54.531210748889556, -6.81312025513508], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Donaghmore, Co. Tyrone</strong><br/><a href="/places/Donaghmore.php">View resources</a>');
		var StPatrickCath = L.marker([54.348037876849645, -6.656671080518698], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Cathedral Church of St. Patrick, Armagh</strong><br/><a href="/places/StPatrickCath.php">View resources</a>');
		var LincolnCath = L.marker([53.23445090005561, -0.5359512293532843], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Lincoln Cathedral</strong><br/><a href="/places/LincolnCath.php">View resources</a>');
		var Hospitaller = L.marker([53.34298855012456, -6.300094260031192], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Hospitaller house, Kilmainham, Co. Dublin</strong><br/><a href="/places/Hospitaller.php">View resources</a>');
		var WestminsterAbbey = L.marker([51.49946837115046, -0.12730131534475056], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Westminster Abbey</strong><br/><a href="/places/WestminsterAbbey.php">View resources</a>');
		var ClonfertCath = L.marker([53.240746466431645, -8.058324987023699], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Clonfert Cathedral, Co. Galway</strong><br/><a href="/places/ClonfertCath.php">View resources</a>');
		var DroghedaDom = L.marker([53.71799324577726, -6.351336075629299], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Drogheda Dominican priory</strong><br/><a href="/places/DroghedaDom.php">View resources</a>');
		var KilkennyDom = L.marker([52.653899031468974, -7.257574029379863], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Kilkenny Dominican priory</strong><br/><a href="/places/KilkennyDom.php">View resources</a>');
		var StThomasMartyr = L.marker([53.34189533431597, -6.280755924061299], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Monastery of St. Thomas Martyr, Dublin</strong><br/><a href="/places/MonasteryStThomas.php">View resources</a>');
		var CastledermotFran = L.marker([52.90857225717626, -6.836974246222986], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Castledermot Franciscan friary, Co. Kildare</strong><br/><a href="/places/CastledermotFran.php">View resources</a>');
		var DroghedaFran = L.marker([53.71844105486766, -6.349343432903698], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Drogheda Franciscan friary</strong><br/><a href="/places/DroghedaFran.php">View resources</a>');
		var WaterfordFran = L.marker([52.2606239826486, -7.10649212761256], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Waterford Franciscan friary</strong><br/><a href="/places/WaterfordFran.php">View resources</a>');
		var DundalkFran = L.marker([54.00627489063146, -6.393836344329416], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Dundalk Franciscan friary, Co. Louth</strong><br/><a href="/places/DundalkFran.php">View resources</a>');
		var LeighlinCarm = L.marker([52.7369175458268, -7.023268375122851], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Leighlin Carmelite house, Co. Carlow</strong><br/><a href="/places/LeighlinCarm.php">View resources</a>');
		var ConallAbbey = L.marker([53.17261952014167, -6.774913159705478], {
			icon: churchIcon
		}).bindPopup('<strong>Location: Conall Abbey, Co. Carlow</strong><br/><a href="/places/ConallAbbey.php">View resources</a>');
		var StMel = L.marker([53.667102696080896, -7.692579048978749], {
			icon: churchIcon
		}).bindPopup('<strong>Location: St. Mel&apos; Cathedral, Co. Longford</strong><br/><a href="/places/StMelCath.php">View resources</a>');
		var StStephen = L.marker([51.49963332126371, -0.1257338312908437], {
			icon: churchIcon
		}).bindPopup('<strong>Location: St. Stephen&apos;s Chapel, Westminster</strong><br/><a href="/places/StStephenChap.php">View resources</a>');
		...
		var RobertAbpDublin = L.marker([53.34345533225444, -6.27106020218046], {
			...
			'<strong>Name: Robert Waldby, Archbishop of Dublin</strong><br/>Role: Witness<br/>Positions: Archbishop of Dublin; Primate of Ireland; Chancellor<br/>Location: Christchurch and St. Patrick&apos;s Cathedral, Dublin<br/><a href="/people/Waldby.php">View resources</a>'
			);
		...
		var JohnAbpArmagh = L.marker([54.348037876849645, -6.656671080518698], {
			...
			'<strong>Name: John Colton, Archbishop of Armagh</strong><br/>Role: Witness<br/>Position: Archbishop of Armagh; Primate of all Ireland<br/>Location: Cathedral Church of St. Patrick<br/><a href="/people/Colton.php">View resources</a>');
		...
		var EdmundVale = L.marker([53.34298855012456, -6.300094260031192], {
			...
			'<strong>Name: Edmund Vale</strong><br/>Role: Witness, Interpreter<br/>Position: Master of the Hospital of St. John of Jerusalem in Ireland<br/>Location: Hospitaller house, Kilmainham<br/><a href="/people/Vale.php">View resources</a>');
		...
		var Auth1 = L.polyline(Ins1R2, {
			color: '#8e44ad',
			offset: -3,
			stroke: 2
		}).bindPopup('<i>Instrument 1</i><br/>Submission of John MacDonald<br/><strong>Authority:</strong> Richard II<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument1.php">View the submission text</a>');
		// John MacDonald
		...
		var Sub1 = L.polyline(Ins1JohnMacDonald, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 1</i><br/><strong>Submitting party:</strong> John MacDonald<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument1.php">View the submission text</a>');
		// Thomas Talbot
		...
		var Int1 = L.polyline(Ins1ThomasTalbot, {
			color: '#27ae60'
		}).bindPopup('<i>Instrument 1</i><br/>Submission of John MacDonald<br/><strong>Interpreter:</strong> Thomas Talbot<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument1.php">View the submission text</a>');
		...
		var Wit1a = L.polyline(Ins1ThomasAbpYork, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit1b = L.polyline(Ins1RobertBpLondon, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit1e = L.polyline(Ins1ThomasPercy, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
		...
		var Wit1f = L.polyline(Ins1WilliamScrope, {
			color: '#f7dc6f',
			offset: 3
		}).bindPopup(
		...
		var Auth2 = L.polyline(Ins2R2, {
			color: '#8e44ad',
			offset: -3
		}).bindPopup('<i>Instrument 2</i><br/>Submission of Catholicus O&apos;Hanlon<br/><strong>Authority:</strong> Richard II<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>');
		// Catholicus O'Hanlon
		...
		var Sub2 = L.polyline(Ins2CatholicusOHanlon, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 2</i><br/><strong>Submitting party:</strong> Catholicus O&apos;Hanlon<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>');
		// Thomas Talbot
		...
		var Int2 = L.polyline(Ins2ThomasTalbot, {
			color: '#27ae60'
		}).bindPopup('<i>Instrument 2</i><br/>Submission of Catholicus O&apos;Hanlon<br/><strong>Interpreter:</strong> Thomas Talbot<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>');
		// Witnesses: Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; Thomas Mowbray; Thomas Percy; William Scrope
		...
		var Wit2a = L.polyline(Ins2ThomasAbpYork, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit2b = L.polyline(Ins2RobertBpLondon, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 2</i><br/>Submission of Catholicus O&apos;Hanlon<br/><strong>Witnesses:</strong> Thomas, Archbishop of York; <strong>Robert, Bishop of London;</strong> Richard, Bishop of Chichester; Thomas Mowbray, Thomas Percy; and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>'
			);
		...
		var Wit2d = L.polyline(Ins2ThomasMowbray, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 2</i><br/>Submission of Catholicus O&apos;Hanlon<br/><strong>Witnesses:</strong> Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; <strong>Thomas Mowbray,</strong> Thomas Percy; and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>'
			);
		...
		var Wit2e = L.polyline(Ins2ThomasPercy, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
			'<i>Instrument 2</i><br/>Submission of Catholicus O&apos;Hanlon<br/><strong>Witnesses:</strong> Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; Thomas Mowbray, <strong>Thomas Percy;</strong> and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>'
		...
		var Wit2f = L.polyline(Ins2WilliamScrope, {
			color: '#f7dc6f',
			offset: 3
		}).bindPopup(
			'<i>Instrument 2</i><br/>Submission of Catholicus O&apos;Hanlon<br/><strong>Witnesses:</strong> Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; Thomas Mowbray, Thomas Percy; and <strong>William Scrope</strong><br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument2.php">View the submission text</a>'
		...
		var Auth3 = L.polyline(Ins3R2, {
			color: '#8e44ad',
			offset: -4
		}).bindPopup('<i>Instrument 3</i><br/>Submission of Donnchadh O&apos;Byrne<br/><strong>Authority:</strong> Richard II<br/>Submission site: Dublin Castle<br/><a href="/instruments/Instrument3.php">View the submission text</a>');
		// Donnchadh O'Byrne
		...
		var Sub3 = L.polyline(Ins3DonnchadhOByrne, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 3</i><br/><strong>Submitting party:</strong> Donnchadh O&apos;Byrne<br/>Submission site: Dublin Castle<br/><a href="/instruments/Instrument3.php">View the submission text</a>');
		...
		var Wit3a = L.polyline(Ins3RobertAbpDublin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit3b = L.polyline(Ins3RichardBpChichester, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 3</i><br/>Submission of Donnchadh O&apos;Byrne<br/><strong>Witnesses:</strong> <strong>Robert, Archbishop of Dublin;</strong> Richard, Bishop of Chichester; Robert, Bishop of Lismore and Waterford; William Scrope; Simon Felbryge; Baldwin Bereford; Thomas Mareward; David Bertevyll<br/>Submission site: Dublin Castle<br/><a href="/instruments/Instrument3.php">View the submission text</a>'
			);
		...
		var Wit3c = L.polyline(Ins3RobertBpLismoreWaterford, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit3d = L.polyline(Ins3WilliamScrope, {
			color: '#f7dc6f',
			offset: -2
		}).bindPopup(
		...
		var Wit3e = L.polyline(Ins3SimonFelbryge, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit3f = L.polyline(Ins3BaldwinBereford, {
			color: '#f7dc6f',
			offset: 2
		}).bindPopup(
		...
		var Wit3g = L.polyline(Ins3ThomasMareward, {
			color: '#f7dc6f',
			offset: -4
		}).bindPopup(
		...
		var Auth4 = L.polyline(Ins4R2, {
			color: '#8e44ad',
			offset: -4
		}).bindPopup('<i>Instrument 4</i><br/>Submission of Art O&apos;Dempsey<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument4.php">View the submission text</a>');
		// Art O'Dempsey
		var Ins4ArtODempsey = [
		...
		var Sub4 = L.polyline(Ins4ArtODempsey, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 4</i><br/><strong>Submitting party:</strong> Art O&apos;Dempsey<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument4.php">View the submission text</a>');
		...
		var Int4 = L.polyline(Ins4JohnMalachy, {
			color: '#27ae60'
		}).bindPopup('<i>Instrument 4</i><br/>Submission of Art O&apos;Dempsey<br/><strong>Interpreter:</strong> John Malachy<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument4.php">View the submission text</a>');
		...
		var Wit4a = L.polyline(Ins4RobertAbpDublin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4b = L.polyline(Ins4PeterAbpCashel, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4d = L.polyline(Ins4TidemanBpLlandaff, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4e = L.polyline(Ins4AlexanderBpMeath, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4f = L.polyline(Ins4RobertBpLismoreWaterford, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4g = L.polyline(Ins4RichardBpOssory, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4h = L.polyline(Ins4ThomasBpElphin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4i = L.polyline(Ins4JohnBpLeighlin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4j = L.polyline(Ins4MilesBpClon, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4k = L.polyline(Ins4EdwardCorkRutland, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit4m = L.polyline(Ins4JohnHolland, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Auth5 = L.polyline(Ins5JohnStanley, {
			color: '#8e44ad',
			offset: -1
		}).bindPopup('<i>Instrument 5</i><br/>Submission of the followers of Art MacMurrough<br/><strong>Authority:</strong> John Stanley<br/>Submission site: New Leighlin<br/><a href="/instruments/Instrument5.php">View the submission text</a>');
		...
		var Sub5 = L.polyline(Ins5MacMurroughFollowers, {
			color: '#e67e22'
		}).bindPopup(
			'<i>Instrument 5</i><br/><strong>Submitting parties:</strong> William Beg, reeve; John Nicholson, reeve; Maurice Adalagh, reeve; Malachy Cam, tenant; John Glasmorgh, tenant (followers of Art MacMurrough)<br/>Submission site: New Leighlin<br/><a href="/instruments/Instrument5.php">View the submission text</a>'
			);
		...
		var Int5 = L.polyline(Ins5FergalOCurran, {
			color: '#27ae60',
			offset: -1
		}).bindPopup(
			'<i>Instrument 5</i><br/>Submission of the followers of Art MacMurrough<br/><strong>Interpreter:</strong> Fergal O&apos;Kurryn<br/>Submission site: New Leighlin<br/><a href="/instruments/Instrument5.php">View the submission text</a>');

		var Wit5a = L.polyline(Ins5FergalOCurran, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
			'<i>Instrument 5</i><br/>Submission of the followers of Art MacMurrough<br/><strong>Witnesses:</strong> <strong>Fergal O&apos;Kurryn</strong>; Robert de Orrey; Henry Bekirton<br/>Submission site: New Leighlin<br/><a href="/instruments/Instrument5.php">View the submission text</a>'
			);
		...
		var Wit5b = L.polyline(Ins5RobertDeOrrey, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 5</i><br/>Submission of the followers of Art MacMurrough<br/><strong>Witnesses:</strong> Fergal O&apos;Kurryn; <strong>Robert de Orrey</strong>; Henry Bekirton<br/>Submission site: New Leighlin<br/><a href="/instruments/Instrument5.php">View the submission text</a>'
			);
		...
		var Wit5c = L.polyline(Ins5HenryBekirton, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 5</i><br/>Submission of the followers of Art MacMurrough<br/><strong>Witnesses:</strong> Fergal O&apos;Kurryn; Robert de Orrey; <strong>Henry Bekirton</strong><br/>Submission site: New Leighlin<br/><a href="/instruments/Instrument5.php">View the submission text</a>'
			);
		...
		var Auth6 = L.polyline(Ins6R2, {
			color: '#8e44ad',
			offset: -1
		}).bindPopup(
			'<i>Instrument 6</i><br/>Submission of Tadhg O&apos;Meagher and Turloch O&apos;Conor Don<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument6.php">View the submission text</a>'
			);
		...
		var Sub6a = L.polyline(Ins6TadhgOMeagher, {
			color: '#e67e22'
		}).bindPopup(
			'<i>Instrument 6</i><br/><strong>Submitting parties:</strong> <strong>Tadhg O&apos;Meagher</strong> and Turloch O&apos;Conor Don<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument6.php">View the submission text</a>'
			);
		...
		var Sub6b = L.polyline(Ins6TurlochOConorDon, {
			color: '#e67e22'
		}).bindPopup(
			'<i>Instrument 6</i><br/><strong>Submitting parties:</strong> Tadhg O&apos;Meagher and <strong>Turloch O&apos;Conor Don</strong><br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument6.php">View the submission text</a>'
			);
		...
		var Int6 = L.polyline(Ins6JohnMalachy, {
			color: '#27ae60'
		}).bindPopup(
			'<i>Instrument 6</i><br/>Submission of Tadhg O&apos;Meagher and Turloch O&apos;Conor Don<br/><strong>Interpreter:</strong> John Malachy<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument6.php">View the submission text</a>'
			);
		...
		var Wit6a = L.polyline(Ins6TidemanBpLlandaff, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit6b = L.polyline(Ins6RobertBpLismoreWaterford, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit6c = L.polyline(Ins6JohnHolland, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit6d = L.polyline(Ins6WilliamScrope, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Auth7 = L.polyline(Ins7R2, {
			color: '#8e44ad',
			offset: -1
		}).bindPopup('<i>Instrument 7</i><br/>Submission of Tadhg MacCarthy Mor<br/><strong>Authority:</strong> Richard II<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument7.php">View the submission text</a>');
		// Tadhg MacCarthy Mor
		...
		var Sub7 = L.polyline(Ins7TadhgMacCarthyMor, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 7</i><br/><strong>Submitting party:</strong> Tadhg MacCarthy Mor<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument7.php">View the submission text</a>');
		...
		var Wit7a = L.polyline(Ins7RichardBpChichester, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 7</i><br/>Submission of Tadhg MacCarthy Mor<br/><strong>Witnesses:</strong> <strong>Richard, Bishop of Chichester</strong>; John Golafre<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument7.php">View the submission text</a>'
			);
		...
		var Wit7b = L.polyline(Ins7JohnGolafre, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
			'<i>Instrument 7</i><br/>Submission of Tadhg MacCarthy Mor<br/><strong>Witnesses:</strong> Richard, Bishop of Chichester; <strong>John Golafre</strong><br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument7.php">View the submission text</a>'
			);
		...
		var Auth8 = L.polyline(Ins8R2, {
			color: '#8e44ad',
			offset: -3
		}).bindPopup('<i>Instrument 8</i><br/>Submission of Niall Og O&apos;Neill<br/><strong>Authority:</strong> Richard II<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument8.php">View the submission text</a>');
		// Niall Og O'Neill
		...
		var Sub8 = L.polyline(Ins8NiallOgONeill, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 8</i><br/><strong>Submitting party:</strong> Niall Og O&apos;<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument8.php">View the submission text</a>');
		// Thomas O'Locheran
		...
		var Int8 = L.polyline(Ins8ThomasOLocheran, {
			color: '#27ae60'
		}).bindPopup(
			'<i>Instrument 8</i><br/>Submission of Niall Og O&apos;Neill<br/><strong>Interpreter:</strong> Thomas O&apos;Locheran<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument8.php">View the submission text</a>');
		...
		var Wit8a = L.polyline(Ins8ThomasAbpYork, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit8b = L.polyline(Ins8JohnAbpArmagh, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit8c = L.polyline(Ins8RobertBpLondon, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit8d = L.polyline(Ins8TidemanBpLlandaff, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit8f = L.polyline(Ins8ThomasPercy, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
		...
		var Auth9 = L.polyline(Ins9R2, {
			color: '#8e44ad',
			offset: -3,
			stroke: 2
		}).bindPopup('<i>Instrument 9</i><br/>Submission of Maurice Magennis<br/><strong>Authority:</strong> Richard II<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument9.php">View the submission text</a>');
		...
		var Sub9 = L.polyline(Ins9MauriceMagennis, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 9</i><br/><strong>Submitting party:</strong> Maurice Magennis<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument9.php">View the submission text</a>');
		...
		var Int9 = L.polyline(Ins9StephenGarnon, {
			color: '#27ae60'
		}).bindPopup('<i>Instrument 9</i><br/>Submission of Maurice Magennis<br/><strong>Interpreter:</strong> Stephen Garnon<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument9.php">View the submission text</a>');
		...
		var Wit9a = L.polyline(Ins9ThomasAbpYork, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit9c = L.polyline(Ins9RichardBpChichester, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit9e = L.polyline(Ins9ThomasMowbray, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit9f = L.polyline(Ins9ThomasPercy, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
		...
		var Wit9g = L.polyline(Ins9WilliamScrope, {
			color: '#f7dc6f',
			offset: 3
		}).bindPopup(
		...
		var Auth10 = L.polyline(Ins10R2, {
			color: '#8e44ad',
			offset: -3,
			stroke: 2
		}).bindPopup('<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Authority:</strong> Richard II<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>');
		// Niall O'Hanlon
		...
		var Sub10 = L.polyline(Ins10NiallOHanlon, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 10</i><br/><strong>Submitting party:</strong> Niall O&apos;Hanlon<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>');
		// Thomas Talbot
		...
		var Int10 = L.polyline(Ins10ThomasTalbot, {
			color: '#27ae60'
		}).bindPopup('<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Interpreter:</strong> Thomas Talbot<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>');
		...
		var Wit10a = L.polyline(Ins10ThomasAbpYork, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit10b = L.polyline(Ins10RobertBpLondon, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Witnesses:</strong>Thomas, Archbishop of York; <strong>Robert, Bishop of London;</strong> Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Thomas Mowbray; Thomas Percy; and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>'
			);
		...
		var Wit10c = L.polyline(Ins10RichardBpChichester, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Witnesses:</strong>Thomas, Archbishop of York; Robert, Bishop of London; <strong>Richard, Bishop of Chichester;</strong> Tideman, Bishop of Llandaff; Thomas Mowbray; Thomas Percy; and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>'
			);
		...
		var Wit10d = L.polyline(Ins10TidemanBpLlandaff, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Witnesses:</strong>Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; <strong>Tideman, Bishop of Llandaff;</strong> Thomas Mowbray; Thomas Percy; and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>'
			);
		...
		var Wit10e = L.polyline(Ins10ThomasMowbray, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Witnesses:</strong>Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; <strong>Thomas Mowbray;</strong> Thomas Percy; and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>'
			);
		...
		var Wit10f = L.polyline(Ins10ThomasPercy, {
			color: '#f7dc6f',
			offset: 1
		}).bindPopup(
			'<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Witnesses:</strong>Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Thomas Mowbray; <strong>Thomas Percy;</strong> and William Scrope<br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>'
		...
		var Wit10g = L.polyline(Ins10WilliamScrope, {
			color: '#f7dc6f',
			offset: 3
		}).bindPopup(
			'<i>Instrument 10</i><br/>Submission of Niall O&apos;Hanlon<br/><strong>Witnesses:</strong>Thomas, Archbishop of York; Robert, Bishop of London; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Thomas Mowbray; Thomas Percy; and <strong>William Scrope</strong><br/>Submission site: Drogheda Dominican Priory<br/><a href="/instruments/Instrument10.php">View the submission text</a>'
		...
		var Auth11 = L.polyline(Ins11R2, {
			color: '#8e44ad',
			stroke: 2
		}).bindPopup('<i>Instrument 11</i><br/>Submission of Adam Tobyn<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument11.php">View the submission text</a>');
		// Adam Tobyn
		var Ins11AdamTobyn = [
			[52.476269, -7.444880],
			[52.653899031468974, -7.257574029379863]
		...
		var Sub11 = L.polyline(Ins11AdamTobyn, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 11</i><br/><strong>Submitting party:</strong> Adam Tobyn<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument11.php">View the submission text</a>');
		...
		var Wit11a = L.polyline(Ins11RobertAbpDublin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit11b = L.polyline(Ins11RichardBpChichester, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit11c = L.polyline(Ins11TidemanBpLlandaff, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Auth12 = L.polyline(Ins12R2, {
			color: '#8e44ad',
			stroke: 2
		}).bindPopup(
			'<i>Instrument 12</i><br/>Submission of Maurice and Thomas MacShane FitzMaurice<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument12.php">View the submission text</a>');
		...
		var Sub12a = L.polyline(Ins12MauriceFitzMaurice, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 12</i><br/><strong>Submitting party:</strong> Maurice and Thomas MacShane FitzMaurice<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument12.php">View the submission text</a>');
		...
		var Sub12b = L.polyline(Ins12ThomasMacShane, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 12</i><br/><strong>Submitting party:</strong> Maurice and Thomas MacShane FitzMaurice<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument12.php">View the submission text</a>');
		...
		var Wit12a = L.polyline(Ins12RobertAbpDublin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit12b = L.polyline(Ins12RichardBpChichester, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 12</i><br/>Submission of Maurice and Thomas MacShane FitzMaurice<br/><strong>Witnesses:</strong> Robert, Archbishop of Dublin; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Robert, Bishop of Lismore and Waterford; Edward, Earl of Cork and Rutland<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument12.php">View the submission text</a>'
			);
		...
		var Wit12d = L.polyline(Ins12RobertBpLismoreWaterford, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 12</i><br/>Submission of Maurice and Thomas MacShane FitzMaurice<br/><strong>Witnesses:</strong> Robert, Archbishop of Dublin; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Robert, Bishop of Lismore and Waterford; Edward, Earl of Cork and Rutland<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument12.php">View the submission text</a>'
			);
		...
		var Wit12e = L.polyline(Ins12EdwardCorkRutland, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 12</i><br/>Submission of Maurice and Thomas MacShane FitzMaurice<br/><strong>Witnesses:</strong> Robert, Archbishop of Dublin; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Robert, Bishop of Lismore and Waterford; Edward, Earl of Cork and Rutland<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument12.php">View the submission text</a>'
			);
		...
		var Auth13 = L.polyline(Ins12R2, {
			color: '#8e44ad',
			stroke: 2
		}).bindPopup(
			'<i>Instrument 13</i><br/>Submission of William and Maeduc Carragh Barrett<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument13.php">View the submission text</a>');
		...
		var Sub13a = L.polyline(Ins13WilliamBarrett, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 13</i><br/><strong>Submitting party:</strong> William and Maeduc Carragh Barrett<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument13.php">View the submission text</a>');
		...
		var Sub13b = L.polyline(Ins13MaeducCarraghBarrett, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 13</i><br/><strong>Submitting party:</strong> William and Maeduc Carragh Barrett<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument13.php">View the submission text</a>');
		...
		var Wit13a = L.polyline(Ins13RobertAbpDublin, {
			color: '#f7dc6f'
		}).bindPopup(
		...
		var Wit13c = L.polyline(Ins13TidemanBpLlandaff, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 13</i><br/>Submission of William and Maeduc Carragh Barrett<br/><strong>Witnesses:</strong> Robert, Archbishop of Dublin; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Robert, Bishop of Lismore and Waterford; Edward, Earl of Cork and Rutland<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument13.php">View the submission text</a>'
			);
		...
		var Wit13d = L.polyline(Ins13RobertBpLismoreWaterford, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 13</i><br/>Submission of William and Maeduc Carragh Barrett<br/><strong>Witnesses:</strong> Robert, Archbishop of Dublin; Richard, Bishop of Chichester; Tideman, Bishop of Llandaff; Robert, Bishop of Lismore and Waterford; Edward, Earl of Cork and Rutland<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument13.php">View the submission text</a>'
			);
		...
		var Auth14 = L.polyline(Ins14R2, {
			color: '#8e44ad',
			stroke: 2
		}).bindPopup('<i>Instrument 14</i><br/>Bernardus O&apos;OBrien<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument14.php">View the submission text</a>');
		...
		var Sub14 = L.polyline(Ins14BernardusOBrien, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 14</i><br/><strong>Submitting party:</strong> Bernardus O&apos;Brien<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument14.php">View the submission text</a>');
		...
		var Wit14a = L.polyline(Ins14RichardScrope, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 14</i><br/>Bernardus O&apos;Brien<br/><strong>Witnesses:</strong> Richard Scrope; William Arundel<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument14.php">View the submission text</a>');
		...
		var Wit14b = L.polyline(Ins14WilliamArundel, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 14</i><br/>Bernardus O&apos;Brien<br/><strong>Witnesses:</strong> Richard Scrope; William Arundel<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument14.php">View the submission text</a>');
		...
		var Auth20 = L.polyline(Ins20R2, {
			color: '#8e44ad',
			stroke: 2
		}).bindPopup('<i>Instrument 20</i><br/>Tadhg and William O&apos;Carroll<br/><strong>Authority:</strong> Richard II<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument20.php">View the submission text</a>');
		...
		var Sub20a = L.polyline(Ins20TadhgOCarroll, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 20</i><br/><strong>Submitting party:</strong> Tadhg and William O&apos;Carroll<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument20.php">View the submission text</a>');
		...
		var Sub20b = L.polyline(Ins20WilliamOCarroll, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 20</i><br/><strong>Submitting party:</strong> Tadhg and William O&apos;Carroll<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument20.php">View the submission text</a>');
		...
		var Wit20a = L.polyline(Ins20RobertApbDublin, {
			...
			'<i>Instrument 20</i><br/>Tadhg and William O&apos;Carroll<br/><strong>Witnesses:</strong><strong>Robert, Archbishop of Dublin</strong>; Thomas Merke<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument20.php">View the submission text</a>'
			);
		...
		var Wit20b = L.polyline(Ins20ThomasMerke, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 20</i><br/>Tadhg and William O&apos;Carroll<br/><strong>Witnesses:</strong><strong>Robert, Archbishop of Dublin</strong>; Thomas Merke<br/>Submission site: Kilkenny Dominican Priory<br/><a href="/instruments/Instrument20.php">View the submission text</a>'
			);
		...
		var Auth22 = L.polyline(Ins22RichardBpOssory, {
			color: '#8e44ad',
			stroke: 2
		}).bindPopup(
			'<i>Instrument 22</i><br/>Submission of Art Og MacMurrough<br/><strong>Authority:</strong> Richard, Bishop of Ossory<br/>Submission site: O&apos;Brenan&apos;s Cross<br/><a href="/instruments/Instrument22.php">View the submission text</a>');
		...
		var Sub22 = L.polyline(Ins22ArtOgMacMurrough, {
			color: '#e67e22'
		}).bindPopup('<i>Instrument 22</i><br/><strong>Submitting party:</strong> Art Og MacMurrough<br/>Submission site: O&apos;Brenan&apos;s Cross<br/><a href="/instruments/Instrument22.php">View the submission text</a>');
		...
		var Wit22a = L.polyline(Ins22FergalOCurran, {
			...
			'<i>Instrument 22</i><br/>Submission of Art Og MacMurrough<br/><strong>Witnesses:</strong><strong>Fergal O&apos;Curran</strong>strong>; Robert Shortall; John Saykyn<br/>Submission site: O&apos;Brenan&apos;s Cross<br/><a href="/instruments/Instrument22.php">View the submission text</a>'
			);
		...
		var Wit22b = L.polyline(Ins22RobertShortal, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 22</i><br/>Submission of Art Og MacMurrough<br/><strong>Witnesses:</strong>Fergal O&apos;Curran; <strong>Robert Shortall</strong>strong>; John Saykyn<br/>Submission site: O&apos;Brenan&apos;s Cross<br/><a href="/instruments/Instrument22.php">View the submission text</a>'
			);
		...
		var Wit22c = L.polyline(Ins22JohnSaykyn, {
			color: '#f7dc6f'
		}).bindPopup(
			'<i>Instrument 22</i><br/>Submission of Art Og MacMurrough<br/><strong>Witnesses:</strong>Fergal O&apos;Curran; Robert Shortall; <strong>John Saykyn</strong>strong><br/>Submission site: O&apos;Brenan&apos;s Cross<br/><a href="/instruments/Instrument22.php">View the submission text</a>'
			);
		...
		// People filters
		var witnesses = L.layerGroup([ThomasAbpYork, JohnStanley, RobertBpLondon, RichardBpChichester, ThomasMowbray, ThomasPercy, WilliamScrope, ThomasSparkeford, RobertAbpDublin, RobertBpLismoreWaterford, SimonFelbryge, BaldwinBereford, ThomasMareward,
			DavidBertevyll, PeterAbpCashel, TidemanBpLlandaff, AlexanderBpMeath, RichardBpOssory, ThomasBpElphin, JohnBpLeighlin, MilesBpClon, EdwardCorkRutland, RogerMarchUlster, JohnHolland, RobertdeOrrey, HenryBekirton, RobertBoleyne, JohnGolafre,
			JohnAbpArmagh, RichardScrope, WilliamArundel, JohnMelton, LawrenceVerkerell, JohnGreyly, NicholasSlake, GalfredoVale, WilliamFaryndon, ThomasClynton, NicholasLangford, ThomasIlketsale, ThomasPykworth, AlanPenynton, JohnBrassebrig,
			EdwardPerys, WalterBytterly, WilliamDrayton, JohnDrayton, RobertLey, DavidWogan, JamesOrmond, ThomasMerke, JohnBorghulle
		]).addTo(map);
		...
		var submitters = L.layerGroup([JohnMacDonald, CatholicusOHanlon, ArtODempsey, WilliamBeg, JohnNicholson, MauriceAdalagh, MalachyCam, JohnGlasmorgh, TurlochOConorDon, TadhgMacCarthyMor, NiallOgONeill, MauriceMagennis, NiallOHanlon, AdamTobyn,
			ThomasMacShane, WilliamBarrett, MaeducCarraghBarrett, BernardusOBrien, MalachyOMore, LugaidhOgOMore, ShaneOMore, ArtOgMacMurrough, MurchadhOConorFaly, GeoffreyOBrenan, FinghinMacGillapatrick, ThomasCarraghKavanagh, LeynaghFerssonOConor,
			OToole, BernardOBrien, DormiciusOBrien, OdoOKennedyFinn, ThomasOKennedyDon, TheobaldFitzWalter, DavidGallBurke, TadhgOCarroll, WilliamOCarroll, WalterBermingham, GillapatrickRuaOMore, NiallONeill, MauriceFitzMaurice, DonalMacCarthy,
			PhilipOKennedy, CormacDermotMacCarthy, CormacDonalMacCarthy, MuirchertachMageoghegan, GillaIsaOReilly, MaolmuireOReilly, ThomasOFarrell, PhilipMacMahon, ODowd, MacDonagh, MacDermot, ORourke, StephenGarnon, JohnBocombe, Magawley, ODunn,
			OwenOMadden, DonnchadhOByrne, TadhgOMeagher, ODea, RobertShortal, ThomasODwyer
		]).addTo(map);
		// Place filters
		var secularSites = L.layerGroup([Westminster, Dungannon, DublinCastle, Tandragee, Ballykean, Ferns, Ballintober, Ballycarbery, Dundrum, Glin, Belleek, ClonroadMore, Dunamase, Rathangan, Castlecomer, Aghaboe, Powerscourt, KilkennyCastle, Nenagh,
			Castleconnell, Gaulstown, BlackCastle, Athenry, Lixnaw, Kilbrittain, KingJohns, Macroom, Reginalds, Geoghegan, Tullymongan, Lissardowlan, Ballygory, CarlowCastle, OBrenansCross, TrinityShip, CarlowCastleMeadow, RochesterCastle, EpworthCastle,
			Clonakenny, NewLeighlin, Ardee, Adlington, Amington, Ballylarkin, Ballymote, Berkhamsted, Bunratty, Castlebrack, Castleconor, Chailesmore, CherryIsland, Cleeton, Clonderalaw, Coity, DundrumTipp, Dysert, Felbrigg, Fotheringay, Guernsey,
			Ilketshall, Kempston, Kingsbury, Lathom, Leeds, Longford, Malahide, Maxstoke, MountTemple, Newcastle, Newgate, Nuneham, PortanTulchain, RathTulach, Ricetown, LoughKey, Sarsden, Swithin, Trim, Wressle, Killamery
		]).addTo(map);
		var eccSites = L.layerGroup([YorkMinster, OldStPauls, ChichesterCath, WellsCath, ChristChurchDub, ChristChurchWat, RockCashel, LlandaffCath, CathPeterPaul, StCaniceCath, StMaryCath, StLaserianCath, StMullins, CoventryCath, LichfieldCath, ElyCath,
			Donaghmore, StPatrickCath, LincolnCath, Hospitaller, WestminsterAbbey, ClonfertCath, DroghedaDom, KilkennyDom, StThomasMartyr, CastledermotFran, DroghedaFran, WaterfordFran, DundalkFran, LeighlinCarm, ConallAbbey, StMel, StStephen
		]).addTo(map);
		var submissionSites = L.layerGroup([DublinCastle, DroghedaDom, KilkennyDom, StThomasMartyr, CastledermotFran, DroghedaFran, WaterfordFran, DundalkFran, LeighlinCarm, ConallAbbey, Ballygory, CarlowCastle, OBrenansCross, TrinityShip,
			CarlowCastleMeadow
		]).addTo(map);
		// Notarial instrument filters
		var instrument1 = L.layerGroup([RichardII, JohnMacDonald, ThomasTalbot, ThomasAbpYork, RobertBpLondon, RichardBpChichester, ThomasMowbray, ThomasPercy, WilliamScrope, Auth1, Sub1, Int1, Wit1a, Wit1b, Wit1c, Wit1d, Wit1e, Wit1f, DroghedaDom,
			Dungannon, Westminster, ChichesterCath, DublinCastle, YorkMinster, OldStPauls, EpworthCastle
		]);
		var instrument2 = L.layerGroup([RichardII, CatholicusOHanlon, ThomasTalbot, ThomasAbpYork, RobertBpLondon, RichardBpChichester, ThomasMowbray, ThomasPercy, WilliamScrope, Auth2, Sub2, Int2, Wit2a, Wit2b, Wit2c, Wit2d, Wit2e, Wit2f, DroghedaDom,
			Westminster, Tandragee, DublinCastle, YorkMinster, OldStPauls, ChichesterCath, EpworthCastle
		]);
		var instrument3 = L.layerGroup([RichardII, DonnchadhOByrne, RobertAbpDublin, RichardBpChichester, RobertBpLismoreWaterford, WilliamScrope, SimonFelbryge, BaldwinBereford, ThomasMareward, DavidBertevyll, Auth3, Sub3, Wit3a, Wit3b, Wit3c, Wit3d,
			Wit3e, Wit3f, Wit3g, Wit3h, DublinCastle
		]);
		var instrument4 = L.layerGroup([RichardII, ArtODempsey, JohnMalachy, RobertAbpDublin, PeterAbpCashel, RichardBpChichester, TidemanBpLlandaff, AlexanderBpMeath, RobertBpLismoreWaterford, RichardBpOssory, ThomasBpElphin, JohnBpLeighlin, MilesBpClon,
			EdwardCorkRutland, RogerMarchUlster, JohnHolland, Auth4, Sub4, Int4, Wit4a, Wit4b, Wit4c, Wit4d, Wit4e, Wit4f, Wit4g, Wit4h, Wit4i, Wit4j, Wit4k, Wit4l, Wit4m, KilkennyDom
		]);
		...
		var instrument8 = L.layerGroup([RichardII, NiallOgONeill, ThomasOLocheran, ThomasAbpYork, JohnAbpArmagh, RobertBpLondon, RichardBpChichester, TidemanBpLlandaff, ThomasMowbray, ThomasPercy, WilliamScrope, Auth8, Sub8, Int8, Wit8a, Wit8b, Wit8c,
			Wit8d, Wit8e, Wit8f, Wit8g, DroghedaDom
		]);
		var instrument9 = L.layerGroup([RichardII, MauriceMagennis, StephenGarnon, ThomasAbpYork, RobertBpLondon, RichardBpChichester, TidemanBpLlandaff, ThomasMowbray, ThomasPercy, WilliamScrope, Auth9, Sub9, Int9, Wit9a, Wit9b, Wit9c, Wit9d, Wit9e,
			Wit9f, Wit9g, DroghedaDom
		]);
		var instrument10 = L.layerGroup([RichardII, NiallOHanlon, ThomasTalbot, ThomasAbpYork, RobertBpLondon, RichardBpChichester, TidemanBpLlandaff, ThomasMowbray, ThomasPercy, WilliamScrope, Auth10, Sub10, Int10, Wit10a, Wit10b, Wit10c, Wit10d, Wit10e,
			Wit10f, Wit10g, DroghedaDom
		]);
		...
		var instrument12 = L.layerGroup([RichardII, MauriceFitzMaurice, ThomasMacShane, RobertAbpDublin, RichardBpChichester, TidemanBpLlandaff, RobertBpLismoreWaterford, EdwardCorkRutland, Auth12, Sub12a, Sub12b, Wit12a, Wit12b, Wit12c, Wit12d, Wit12e,
			KilkennyDom, Westminster, Glin, Lixnaw, ChristChurchDub, ChichesterCath, LlandaffCath, ChristChurchWat, Fotheringay
		]);
		var instrument13 = L.layerGroup([RichardII, WilliamBarrett, MaeducCarraghBarrett, RobertAbpDublin, RichardBpChichester, TidemanBpLlandaff, RobertBpLismoreWaterford, EdwardCorkRutland, Auth13, Sub13a, Sub13b, Wit12a, Wit12b, Wit12c, Wit12d, Wit12e,
			KilkennyDom, Westminster, Belleek, ChristChurchDub, ChichesterCath, LlandaffCath, ChristChurchWat, Fotheringay
		]);
			...
			children: [{
				...
				},
				{
					...
					children: [{
						...
						{
							label: 'Ecclesiastical Sites',
							layer: eccSites
						},
						{
							label: 'Submission Sites',
							layer: submissionSites
						},
					]
				}
			]
		...
		var submissionsTree = {
			...
			selectAllCheckbox: 'Un/select all',
			children: [{
					label: 'Instrument 1:<br/> <i>John MacDonald</i>',
					layer: instrument1
				},
				{
					label: 'Instrument 2:<br/> <i>Catholicus O&apos;Hanlon</i>',
					layer: instrument2
				},
				{
					label: 'Instrument 3:<br/> <i>Donnchadh O&apos;Byrne</i>',
					layer: instrument3
				},
				{
					label: 'Instrument 4:<br/> <i>Art O&apos;Dempsey</i>',
					layer: instrument4
				},
				{
					label: 'Instrument 5:<br/> <i>Followers of Art MacMurrough</i>',
					layer: instrument5
				},
				{
					label: 'Instrument 6:<br/> <i>Tadhg O&apos;Meagher and Turloch O&apos;Conor Don</i>',
					layer: instrument6
				},
				{
					label: 'Instrument 7:<br/> <i>Tadhg MacCarthy Mor</i>',
					layer: instrument7
				},
				{
					label: 'Instrument 8:<br/> <i>Niall Og O&apos;Neill</i>',
					layer: instrument8
				},
				{
					label: 'Instrument 9:<br/> <i>Maurice Magennis</i>',
					layer: instrument9
				},
				{
					label: 'Instrument 10:<br/> <i>Niall O&apos;Hanlon</i>',
					layer: instrument10
				},
				{
					label: 'Instrument 11:<br/> <i>Adam Tobyn</i>',
					layer: instrument11
				},
				{
					label: 'Instrument 12:<br/> <i>Maurice FitzMaurice and Thomas MacShane</i>',
					layer: instrument12
				},
				{
					label: 'Instrument 13:<br/> <i>William Barrett and Maeduc Carragh Barrett</i>',
					layer: instrument13
				},
				{
					label: 'Instrument 14:<br/> <i>Bernardus O&apos;Brien</i>',
					layer: instrument14
				},
				//		{ label: 'Instrument 15: ', layer: instrument15}
				{
					label: 'Instrument 16:<br/> <i>Niall Og O&apos;Neill, John MacDonald, and Maurice Magennis</i>',
					layer: instrument16
				},
				//		{ label: 'Instrument 17: ', layer: instrument17}
				{
					label: 'Instrument 18:<br/> <i>Bernardus O&apos;Brien</i>',
					layer: instrument18
				},
				//		{ label: 'Instrument 19: ', layer: instrument19}
				{
					label: 'Instrument 20:<br/> <i>Tadhg O&apos;Carroll and William O&apos;Carroll</i>',
					layer: instrument20
				},
				//		{ label: 'Instrument 21: ', layer: instrument21}
				{
					label: 'Instrument 22:<br/> <i>Art Og MacMurrough</i>',
					layer: instrument22
				},
				...
				{
					label: 'Instrument 29:<br/> <i>Niall O&apos;Neill and Niall Og O&apos;Neill</i>',
					layer: instrument29
				},
				{
					label: 'Instrument 30:<br/> <i>Tadhg MacCarthy Mor and Donal MacCarthy [Reagh]</i>',
					layer: instrument30
				},
				...
				{
					label: 'Instrument 34:<br/> <i>Turloch O&apos;Conor Don</i>',
					layer: instrument34
				},
				{
					label: 'Instrument 35:<br/> <i>Cormac MacCarthy [Muskerry] and Cormac MacCarthy [Reagh]</i>',
					layer: instrument35
				},

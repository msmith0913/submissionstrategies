...
// People
		var RichardII = L.marker([51.48398083527779, -0.6044134311929068], {
			color: 'red',
			fillColor: '#f03',
			fillOpacity: 0.5,
			radius: 30
		}).bindPopup('<strong>Name: Richard II</strong><br/><Role: Authority<br/>Positions: King of England and France; Lord of Ireland<br/>Location: Windsor Castle<br/><a href="www.example.org">View resources</a>');
		...
		var WilliamOCormacan = L.marker([53.240746466431645, -8.058324987023699], {
			...
			fillOpacity: 0.5,
			radius: 30
		}).bindPopup('<strong>Name: William O&apos;Cormacan</strong><br/>Role: Interpreter<br/>Position: Bishop of Clonfert<br/>Location: Clonfert Cathedral<br/><a href="/richard-ii/people/OCormacan.html">View resources</a>');

...
<body>
  <header>
    ...
    <p>Jump to:
    <ul>
      <li><a target="_self" href="/people/Luttrell.php#HughLuttrell">Hugh Luttrell</a></li>
  ...
  <script>
    ...
    L.marker([51.24904081361839, 0.6298944235039807], {icon: castleIcon}).bindPopup('<strong>Location: Leeds Castle</strong>').addTo(map);
    </script>
</div>
</div>
<br/>
...
if (x.style.display === "none") {
  ...
  <hr>
  <h2 id="HughLuttrell">Hugh Luttrell</a></h2>
  ...
  <h4>About</h4>
    <p>Hugh Luttrell was constable of Leeds Castle from 1393 to 1399..</p>
  <h4>Location</h4>
  <p><a href="/places/LeedsCastle.php">Leeds Castle</a></p>
  <h4>Further Reading</h4>
  <p>J.S. Roskell and C.L. Clark, eds., <a href="https://www.historyofparliamentonline.org/volume/1386-1421/member/luttrell-sir-hugh-1364-1428"><i>The History of Parliament: the House of Commons 1386-1421</i></a> (Rawcliffe, 1993).</p>
    <br/>
  <h2>Contributors</h2>

...
<body>
  <header>
    ...
    <p>Jump to:
    <ul>
      <li><a target="_self" href="/people/Melton.php#JohnMelton">John Melton</a></li>
...
if (x.style.display === "none") {
  ...
  <hr>
  <h2 id="JohnMelton">John Melton</a></h2>
  ...
  <h4>About</h4>
    <p>John Melton is described in the submissions as a clerk of Lincoln diocese.</p>
  <h4>Location</h4>
  <p><a href="/places/LincolnCath.php">Lincoln Cathedral</a></p>

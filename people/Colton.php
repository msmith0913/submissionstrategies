...
<body>
  ...
  <script>
    ...
    L.marker([54.348037876849645, -6.656671080518698], {icon: churchIcon}).bindPopup('<strong>Location: St. Patrick&apos;s Cathedral</strong>').addTo(map);
    </script>
</div>
</div>
  <hr>
  ...
  <h4>About</h4>
    <p>John Colton was Archbishop of Armagh from 1383 to 1404.</p>
  <h4>Location</h4>
  <p><a href="/places/StPatrickCath.php">St. Patrick's Cathedral</a></p>
  <h4>Further Reading</h4>
<p>D.B. Johnston, <a href="https://doi.org/10.1093/ref:odnb/6000">"Colton, John,"</a> <i>Oxford Dictionary of National Biography</i></p>
<p><a href="https://en.wikipedia.org/wiki/John_Colton_(bishop)">"John Colton (bishop),"</a> Wikipedia</p>
  <br/>
  <h2>Contributors</h2>

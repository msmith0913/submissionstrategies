...
<body>
  ...
  <script>
    ...
    L.marker([52.73610773387068, -7.025380359884095], {icon: churchIcon}).bindPopup('<strong>Location: St. Laserian&apos;s Cathedral</strong>').addTo(map);
    </script>
</div>
</div>
<br/>
...
<h4>Full bibliographic information is available on the <a href="/instruments.php">Sources page</a></h4>
  ...
  <hr>
  <h2>John Griffin, Bishop of Leighlin</a></h2>
  ...
  <h4>About</h4>
    <p>John Griffin was Bishop of Leighlin from 1385-1399.</p>
  <h4>Location</h4>
  <p><a href="/places/StLaserianCath.php">St. Laserian's Cathedral</a></p>

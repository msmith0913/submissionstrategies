...
<head>
  ...
  <title>Places: Clonfert Cathedral</title>
...
<body>
  ...
  <h1>Clonfert Cathedral</h1>
  <h3 style="text-align: center;"><a href="https://www.logainm.ie/en/17732">Glebe, Co. Galway</a></h3>
  <h4>Associated People</h4>
    <p><a href="/people/OCormacan.php">William O'Cormacan</a></p>
  <h4>Coordinates:</h4><p>53.240746466431645, -8.058324987023699</p>
  ...
  <script>
    ...
    L.marker([53.240746466431645, -8.058324987023699], {icon: churchIcon}).bindPopup('<strong>Location: Clonfert Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>Clonfert Cathedral was the seat of the diocese of Clonfert.</p>
  <h4>Sources and Further Reading</h4>
  <p>Henry S. Crawford, "The Romanesque Doorway at Clonfert," <i>Journal of the Royal Society of Antiquaries of Ireland</i>, 2, no. 1 (1912): 1-7.</p>
  <p>Peter Harbison, "The 'Balintober Master' and a date for the Clonfert Cathedral Chancel," <i>Journal of the Galway Archaeological and Historical Society</i> 35 (1976): 96-99.</p>
    <br/>
  <h2>Contributors</h2>

...
<head>
  ...
  <title>Places: Christchurch Cathedral</title>
...
<body>
  ...
  <h4>Coordinates:</h4><p>53.34345533225444, -6.27106020218046</p>
  ...
  <script>
    ...
    L.marker([53.34345533225444, -6.27106020218046], {icon: churchIcon}).bindPopup('<strong>Location: Christ Church Cathedral</strong>').addTo(map);
    </script>
...
<p>Although Waldby spent very little time in his diocese while Archbishop of Dublin, the city's two cathedrals were the seat of his authority. Dublin was unusual in having two cathedrals that shared the rights and duties of the archdiocesan seat: Christ Church and St. Patrick's.</p>
  ...
  <p>Site record for DU018-020270-, <i>Archaeological Survey of Ireland</i>.</p>

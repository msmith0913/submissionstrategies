...
<head>
  ...
  <title>Places: Ely Cathedral</title>
...
<body>
  ...
  <h1>Ely Cathedral</h1>
  <h3 style="text-align: center;">Ely, Cambridgeshire</h3>
  <h4>Associated People</h4>
    <p><a href="/people/Boleyne.php#RobertBoleyne">Robert Boleyne</a></p>
  <h4>Coordinates:</h4><p>52.3989490180776, 0.2624057062999244</p>
  ...
  <script>
    ...
    L.marker([52.3989490180776, 0.2624057062999244], {icon: churchIcon}).bindPopup('<strong>Location: Ely Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>Robert Boleyne describes himself as a clerk of Ely diocese, so Ely Cathedral stands in as a seat of authority in the absence of any more specific location.</p>

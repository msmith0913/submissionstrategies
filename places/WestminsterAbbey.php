...
<head>
  ...
  <title>Places: Westminster Abbey</title>
...
<body>
  ...
  <h3 style="text-align: center;">City of Westminster, London, England</h3>
  <h4>Associated People</h4>
    <p><a href="/people/Merke.php">Thomas Merke</a></p>
  <h4>Coordinates:</h4><p>51.49942213076493, -0.12731618229189637</p>
  ...
  <script>
    ...
    L.marker([51.49942213076493, -0.12731618229189637], {icon: churchIcon}).bindPopup('<strong>Location: Westminster Abbey</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>Thomas Merke is described as a monk of Westminster.</p>

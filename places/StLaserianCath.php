...
<head>
  ...
  <title>Places: St. Laserian's Cathedral</title>
...
<body>
  ...
  <h1>St. Laserian's Cathedral</h1>
  <h3 style="text-align: center;"><a href="https://www.logainm.ie/en/3443">Oldleighlin, Co. Carlow</a></h3>
  <h4>Associated People</h4>
    <p><a href="/people/Griffin.php">John Griffin</a></p>
  <h4>Coordinates:</h4><p>52.73610773387068, -7.025380359884095</p>
  ...
  <script>
    ...
    L.marker([52.73610773387068, -7.025380359884095], {icon: churchIcon}).bindPopup('<strong>Location: St. Laserian&apos; Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>Clonfert Cathedral was the seat of the diocese of Clonfert.</p>
  <h4>Sources and Further Reading</h4>
<p>Site record for CW011-016005-, derived from <i>Archaeological Inventory of Co. Carlow</i> (Dublin: Stationery Office, 1993).</p>
    <br/>
  <h2>Contributors</h2>

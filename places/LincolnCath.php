...
<head>
  ...
  <title>Places: Lincoln Cathedral</title>
...
<body>
  ...
  <h1>Lincoln Cathedral</h1>
  <h3 style="text-align: center;">Lincoln, Lincolnshire, England</h3>
  <h4>Associated People</h4>
    <p><a href="/people/Melton.php">John Melton</a></p>
  <h4>Coordinates:</h4><p>53.23445090005561, -0.5359512293532843</p>
  ...
  <script>
    ...
    L.marker([53.23445090005561, -0.5359512293532843], {icon: churchIcon}).bindPopup('<strong>Location: Lincoln Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>Lincoln Cathedral was the seat of the diocese.</p>

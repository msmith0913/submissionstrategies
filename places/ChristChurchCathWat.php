...
<head>
  ...
  <title>Places: Christ Church Cathedral</title>
...
<body>
  ...
  <h3 style="text-align: center;"><a href="https://www.logainm.ie/en/1383828">Waterford, Ireland</a></h3>
  <h4>Associated People</h4>
    <p><a href="/people/Read.php">Robert Read</a></p>
  <h4>Coordinates:</h4><p>52.26005051914892, -7.107510486891409</p>
  ...
  <script>
    ...
    L.marker([52.26005051914892, -7.107510486891409], {icon: churchIcon}).bindPopup('<strong>Location: Christ Church Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>Christ Church Cathedral was the seat of the diocese of Lismore and Waterford.</p>

...
<head>
  ...
  <title>Places: Lichfield Cathedral</title>
...
<body>
  ...
  <h1>Lichfield Cathedral</h1>
  <h3 style="text-align: center;>Lichfield, Staffordshire</h3>
  <h4>Associated People</h4>
    <p><a href="/people/Bekirton.php">Henry Bekirton</a></p>
  <h4>Coordinates:</h4><p>52.68563576496434, -1.8303309315376164</p>
  ...
  <script>
    ...
    L.marker([52.68563576496434, -1.8303309315376164], {icon: churchIcon}).bindPopup('<strong>Location: Lichfield Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
  <p>The submissions describe Henry Bekirton as being "of Lichfield diocese." In the absence of a more specific location, Lichfield Cathedral stands in as the center of authority for the diocese.</p>

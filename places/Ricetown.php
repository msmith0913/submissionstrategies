...
<body>
  ...
  <h1>Ricetown</h1>
  <h3 style="text-align: center;"><a href="https://www.logainm.ie/en/37666">Ricetown, Co. Meath</a></h3>
  <h4>Associated People</h4>
    <p><a href="/people/Bocombe.php">John Bocombe</a></p>
  <h4>Coordinates:</h4><p>53.781099569143734, -6.676733656357843</p>
  ...
  <script>
    ...
    L.marker([53.781099569143734, -6.676733656357843], {icon: castleIcon}).bindPopup('<strong>Location: Ricetown</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
  <p>In 1391, John Bocombe was a tenant in Ricetown (Dowdall 318). (NB: the Dowdall deed records a suit over ownership of Ricetown, so he may have moved prior to 1395.)</p>
  <h4>Sources and Further Reading</h4>
  <p>Charles McNeill and A.J. Otway-Ruthven, eds., <i><a href="https://www.irishmanuscripts.ie/product/dowdall-deeds/">Dowdall Deeds</a></i> (Dublin: Stationery Office, 1960): 128 (Deed 318).</p>
  <br/>
  <h2>Contributors</h2>

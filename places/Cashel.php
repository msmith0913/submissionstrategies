...
<head>
  ...
  <title>Places: Rock of Cashel</title>
...
<body>
  ...
  <h1>Rock of Cashel</h1>
  <h3 style="text-align: center;"><a href="https://www.logainm.ie/en/47551">Saint Patricksrock, Co. Tipperary</a></h3>
  <h4>Associated People</h4>
    <p><a href="/people/Hackett.php">Peter Hackett</a></p>
  <h4>Coordinates:</h4><p>52.52018726099023, -7.890430744550451</p>
  ...
  <script>
    ...
    L.marker([52.52018726099023, -7.890430744550451], {icon: churchIcon}).bindPopup('<strong>Location: Rock of Cashel</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
<p>The Rock housed the cathedral church for the archdiocese of Cashel from the thirteenth century.</p>
  <h4>Sources and Further Reading</h4>
<p>Jean Farrelly, site record for TS061-025003-, <i>Archaeological Survey of Ireland</i>.</p>
    <br/>
  <h2>Contributors</h2>

...
<head>
  ...
  <title>Places: St. Canice's Cathedral</title>
...
<body>
  ...
  <h1>St. Canice's Cathedral</h1>
  <h3 style="text-align: center;"><a href="https://www.logainm.ie/en/1399926">Kilkenny, Co. Kilkenny</a></h3>
  <h4>Associated People</h4>
    <p><a href="/people/Northalis.php">Richard Northalis</a></p>
  <h4>Coordinates:</h4><p>52.65676829073725, -7.257265996886012</p>
  ...
  <script>
    ...
    L.marker([52.65676829073725, -7.257265996886012], {icon: churchIcon}).bindPopup('<strong>Location: St. Canice&apos; Cathedral</strong>').addTo(map);
    </script>
  <h4>How was it located?</h4>
  <p>St. Canice's was the seat of the diocese from the thirteenth century.</p>

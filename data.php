...
<p><strong><a href="https://github.com/msmith0913/submissionstrategies/blob/main/data/PersonRelations.json">Relationship Types JSON: </a></strong>This JSON contains network data linking individuals to each other and encodes the relationship type. It requires further cleaning, but it's a useful document if you want to experiment with visualizations. You can fork my network viz, or you can create your own.</p>
<p><strong><a href="https://github.com/msmith0913/submissionstrategies/blob/main/data/Instruments.json">Instruments JSON: </a></strong>This JSON also contains network data, but it links individuals via the instruments, which stand in for the specific events of submission. It also requires some clean-up, but feel free to fork or adapt.</p>
</main>
<footer>

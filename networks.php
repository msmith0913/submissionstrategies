...
<main>
	<h1>Networks</h1>
	<p>These network graphs show the connections between parties documented in the sources. They are constructed in <a href="https://observablehq.com/explore">Observable</a> using the D3.js library.</p>
	<p>Like the map, these networks are based on data extracted and cleaned from the submissions - but it's important to note that data cleaning is not clear-cut. The process involves a series of decisions about what data to include, what and how to
		...
		<p>The first network graph shows the notarial instruments as green nodes, connected to all the people (represented as blue nodes) who were present at the submission event. Hover over a node to see the name or instrument number. Click on a node to access a link to the person or instrument's authority file. Click on any node to dismiss the popup.</p>
